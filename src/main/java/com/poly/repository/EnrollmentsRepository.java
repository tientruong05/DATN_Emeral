...
public interface EnrollmentsRepository extends JpaRepository<Enrollment, Long> {
    ...
    Long countEnrollments(@Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
    ...
    List<Object[]> findTopCoursesByRevenue(@Param("startDate") LocalDate startDate,
    ...
    Long countEnrollmentsByCategory(@Param("tenDanhMuc") String tenDanhMuc, @Param("startDate") LocalDate startDate,
            @Param("endDate") LocalDate endDate);
